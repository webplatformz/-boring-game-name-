...
| Player collection, packs, language, preferences and Debate record | Browser-only | No project account or server transfer. Data remains until the visitor clears site storage. |
