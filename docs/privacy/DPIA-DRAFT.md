...
Data categories and sources are documented on the public Data Methodology and provenance pages. Recipients are the unrestricted public, GitHub Pages for static hosting and Google for correspondence sent to the published Gmail privacy address. GitHub may process data in the United States and other countries where it or its subprocessors operate. The controllers must keep the applicable provider terms and transfer safeguards under review.
...
| Hosting recipient or foreign transfer is misunderstood | High | GitHub Pages and international processing disclosed; self-hosted fonts; no intentional analytics/ads | Medium; provider terms and safeguards require periodic review |
...
- browser-only player state; no account, advertising or intentional analytics profile;
...
2. Confirm that GitHub Pages remains the production host and record the applicable provider terms, transfer safeguards and available log information.
