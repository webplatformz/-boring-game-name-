...
const en = {
  ...
  achievementsIntro: 'Milestones for collecting, opening packs, trading and more. Each one unlocks a bonus pack the moment you earn it.',
  ...
  achPackOpener10Desc: 'Open 10 packs.',
  achPackOpener100Title: 'Pack Opener Pro',
  achPackOpener100Desc: 'Open 100 packs.',
  achPackOpener1000Title: 'Pack Opener Legend',
  achPackOpener1000Desc: 'Open 1,000 packs.',
  ...
  achTradeVeteranDesc: 'Complete 100 trade-ins.',
  achTradeMasterTitle: 'Trade Master',
  achTradeMasterDesc: 'Complete 1,000 trade-ins.',
  achDailyLogin7Title: 'Weekly Regular',
  achDailyLogin7Desc: 'Open a pack 7 days in a row.',
  achDailyLogin30Title: 'Monthly Regular',
  achDailyLogin30Desc: 'Open a pack 30 days in a row.',
  achDailyLogin100Title: 'Creature of Habit',
...
const de: Partial<Record<TranslationKey, string>> = {
  ...
  achievements: 'ERFOLGE', achievementsLinkAria: 'Erfolge öffnen', achievementUnlocked: 'ERFOLG FREIGESCHALTET', achievementRewardShort: '+{count} PACK', achievementsEyebrow: 'RUHMESHALLE', achievementsTitle: 'ERFOLGE', achievementsIntro: 'Meilensteine fürs Sammeln, Packs öffnen, Tauschen und mehr. Jeder schaltet sofort ein Bonus-Pack frei.', achievementsCount: '{unlocked} VON {total} FREIGESCHALTET', achievementsHiddenTeaser: '{count} GEHEIME ERFOLGE NOCH GESPERRT',
  ...
  achPackOpener10Title: 'Pack-Öffner', achPackOpener10Desc: 'Öffne 10 Packs.', achPackOpener100Title: 'Pack-Profi', achPackOpener100Desc: 'Öffne 100 Packs.', achPackOpener1000Title: 'Pack-Legende', achPackOpener1000Desc: 'Öffne 1000 Packs.',
...
const fr: Partial<Record<TranslationKey, string>> = {
  ...
  achievements: 'SUCCÈS', achievementsLinkAria: 'Ouvrir les succès', achievementUnlocked: 'SUCCÈS DÉBLOQUÉ', achievementRewardShort: '+{count} PACK', achievementsEyebrow: 'PANTHÉON', achievementsTitle: 'SUCCÈS', achievementsIntro: 'Des étapes pour collectionner, ouvrir des packs, échanger et plus encore. Chacune débloque aussitôt un pack bonus.', achievementsCount: '{unlocked} SUR {total} DÉBLOQUÉS', achievementsHiddenTeaser: '{count} SUCCÈS SECRETS ENCORE VERROUILLÉS',
  ...
  achPackOpener10Title: 'Ouvreur de packs', achPackOpener10Desc: 'Ouvre 10 packs.', achPackOpener100Title: 'Pro des packs', achPackOpener100Desc: 'Ouvre 100 packs.', achPackOpener1000Title: 'Légende des packs', achPackOpener1000Desc: 'Ouvre 1000 packs.',
...
const it: Partial<Record<TranslationKey, string>> = {
  ...
  achievements: 'OBIETTIVI', achievementsLinkAria: 'Apri gli obiettivi', achievementUnlocked: 'OBIETTIVO SBLOCCATO', achievementRewardShort: '+{count} PACK', achievementsEyebrow: 'ALBO D’ORO', achievementsTitle: 'OBIETTIVI', achievementsIntro: 'Traguardi per collezionare, aprire pacchetti, scambiare e altro ancora. Ognuno sblocca subito un pacchetto bonus.', achievementsCount: '{unlocked} DI {total} SBLOCCATI', achievementsHiddenTeaser: '{count} OBIETTIVI SEGRETI ANCORA BLOCCATI',
  ...
  achPackOpener10Title: 'Apripacchi', achPackOpener10Desc: 'Apri 10 pacchetti.', achPackOpener100Title: 'Professionista dei pack', achPackOpener100Desc: 'Apri 100 pacchetti.', achPackOpener1000Title: 'Leggenda dei pack', achPackOpener1000Desc: 'Apri 1000 pacchetti.',
