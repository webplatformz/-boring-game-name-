...
const de: Partial<Record<TranslationKey, string>> = {
  ...
  collectionTitle: 'DIE SAMMLUNG', collectionCount: '{owned} VON {total} MITGLIEDERN', rarity: 'SELTENHEIT', name: 'NAME', cantons: 'KANTONE', cantonCount: '{count} K', member: 'MITGLIED',
  ...
  tradeReady: '5 KARTEN TAUSCHEN → 1× {rarity}', tradeSelect: '5 {rarity}-KARTEN WÄHLEN', availableCards: 'VERFÜGBARE {rarity}-KARTEN', types: '{count} ARTEN', availableShort: '{count} verf.', noRarityOwned: 'KEINE {rarity}-KARTEN', acquireRarity: 'Öffne Packs oder tausche niedrigere Seltenheiten, um {rarity}-Karten zu erhalten.',
...
const fr: Partial<Record<TranslationKey, string>> = {
  ...
  collectionTitle: 'LA COLLECTION', collectionCount: '{owned} SUR {total} MEMBRES', rarity: 'RARETÉ', name: 'NOM', cantons: 'CANTONS', cantonCount: '{count} C', member: 'MEMBRE', nothingHere: 'RIEN POUR L’INSTANT', collectionEmpty: 'Ouvre ton premier pack et {count} parlementaires apparaîtront dans ce tableau.', getPack: 'OBTENIR UN PACK', tradeTitle: 'ÉCHANGE DE CARTES', tradeSubtitle: 'ÉCHANGE 5 CARTES CONTRE 1 DE RARETÉ SUPÉRIEURE', selectedCount: '{count} / 5 SÉLECTIONNÉES', autoFill: 'REMPLIR AUTO', dupes: 'DOUBLONS', clear: 'EFFACER', tradeReady: 'ÉCHANGER 5 CARTES → 1 {rarity}', tradeSelect: 'SÉLECTIONNE 5 CARTES {rarity}', availableCards: 'CARTES {rarity} DISPONIBLES', types: '{count} TYPES', availableShort: '{count} disp.', noRarityOwned: 'AUCUNE CARTE {rarity}', acquireRarity: 'Ouvre des packs ou échange des cartes moins rares pour obtenir des cartes {rarity}.',
...
const it: Partial<Record<TranslationKey, string>> = {
  ...
  collectionTitle: 'LA COLLEZIONE', collectionCount: '{owned} DI {total} MEMBRI', rarity: 'RARITÀ', name: 'NOME', cantons: 'CANTONI', cantonCount: '{count} C', member: 'MEMBRO', nothingHere: 'ANCORA NIENTE', collectionEmpty: 'Apri il primo pacchetto e {count} parlamentari appariranno in questa tabella.', getPack: 'OTTIENI UN PACK', tradeTitle: 'SCAMBIO DI CARTE', tradeSubtitle: 'SCAMBIA 5 CARTE CON 1 DI RARITÀ SUPERIORE', selectedCount: '{count} / 5 SELEZIONATE', autoFill: 'RIEMPI AUTO', dupes: 'DOPPIONI', clear: 'SVUOTA', tradeReady: 'SCAMBIA 5 CARTE → 1 {rarity}', tradeSelect: 'SELEZIONA 5 CARTE {rarity}', availableCards: 'CARTE {rarity} DISPONIBILI', types: '{count} TIPI', availableShort: '{count} disp.', noRarityOwned: 'NESSUNA CARTA {rarity}', acquireRarity: 'Apri pacchetti o scambia carte meno rare per ottenere carte {rarity}.',
