...
const de: Partial<Record<TranslationKey, string>> = {
  ...
  tabPacks: 'PACKS', tabCollection: 'SAMMLUNG', tabBattle: 'DEBATTE', tabTrade: 'TAUSCH',
...
const fr: Partial<Record<TranslationKey, string>> = {
  ...
  home: '← ACCUEIL', battleTitle: 'DÉBAT', winsShort: '{count}V', lossesShort: '{count}D', noFighters: 'AUCUNE CARTE DE DÉBAT', noFightersBody: 'Ouvre d’abord un pack — il te faut au moins une carte pour débattre.', chooseFighter: 'CHOISIS TA CARTE DE DÉBAT', opponent: 'ADVERSAIRE', yourCard: 'TA CARTE', attack: 'ATTAQUER', defend: 'DÉFENDRE', attacked: 'ATTAQUE', defended: 'DÉFENSE', lockingIn: 'VALIDATION…', youWon: 'VICTOIRE !', youLost: 'DÉFAITE',
...
const it: Partial<Record<TranslationKey, string>> = {
  ...
  home: '← HOME', battleTitle: 'DIBATTITO', winsShort: '{count}V', lossesShort: '{count}S', noFighters: 'NESSUNA CARTA DA DIBATTITO', noFightersBody: 'Apri prima un pacchetto: serve almeno una carta per un dibattito.', chooseFighter: 'SCEGLI LA CARTA DA DIBATTITO', opponent: 'AVVERSARIO', yourCard: 'LA TUA CARTA', attack: 'ATTACCA', defend: 'DIFENDI', attacked: 'ATTACCATO', defended: 'DIFESO', lockingIn: 'CONFERMA…', youWon: 'HAI VINTO!', youLost: 'HAI PERSO',
