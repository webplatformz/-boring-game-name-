...
const en: PrivacyContent = {
  privacy: {
    ...
    categories: [
      ...
      { title: 'Technical access data', body: 'GitHub Pages may receive IP address, request time, requested URL, browser information and security logs when serving the site.' },
    ],
...
const de: PrivacyContent = {
  privacy: {
    ...
    categoriesTitle: 'Betroffene Personen und Datenkategorien', categories: [
      ...
      { title: 'Technische Zugriffsdaten', body: 'GitHub Pages kann beim Ausliefern der Seite IP-Adresse, Zeitpunkt, URL, Browserangaben und Sicherheitsprotokolle verarbeiten.' },
    ],
    purposesTitle: 'Zwecke', purposes: ['Betrieb eines unabhängigen, nicht kommerziellen Lern- und Kartenspiels.', 'Erklärung ausgewählter öffentlicher Parlamentsaktivitäten und der projektseitigen Wertungsmethode.', 'Berechnung fiktiver vergleichender Spielwerte und Seltenheiten.', 'Sicherstellung der Richtigkeit, Bearbeitung von Betroffenenrechten und Schutz des Dienstes.', 'Keine politische Zielwerbung, Prognose der Wahlabsicht, Eignungsentscheidung oder Entscheidung mit rechtlicher oder ähnlich erheblicher Wirkung.'],
...
const fr: PrivacyContent = {
  ...
  methodology: {
    ...
    minimisationTitle: 'Minimisation', minimisationBody: 'L’application distribuée exclut les champs sources inutilisés et ne publie ni votes détaillés ni registre intermédiaire de calcul. Les instantanés bruts restent séparés avec des durées à approuver. Aucun compte visiteur ni profil analytique n’est créé.',
...
const it: PrivacyContent = {
  ...
  methodology: {
    ...
    minimisationTitle: 'Minimizzazione', minimisationBody: 'L’app distribuita esclude i campi di origine inutilizzati e non pubblica righe di voto dettagliate né il registro intermedio dei calcoli. Gli snapshot grezzi restano separati e richiedono termini approvati. Non vengono creati account visitatore o profili analitici.',
